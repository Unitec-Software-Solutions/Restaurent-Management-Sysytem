...
class ExhaustiveMenuSeeder extends Seeder
{
    ...
    private function createSimpleCafeMenu(Organization $org): void
    {
        ...
        $menuItems = [
            // Coffee & Tea
            ['category' => 'Coffee & Tea', 'name' => 'Espresso', 'price' => 250, 'prep_time' => 2, 'ingredients' => ['espresso_beans'], 'allergens' => json_encode([]), 'dietary' => ['vegan_option']],
            ['category' => 'Coffee & Tea', 'name' => 'Cappuccino', 'price' => 350, 'prep_time' => 3, 'ingredients' => ['espresso_beans', 'milk'], 'allergens' => json_encode(['dairy']), 'dietary' => ['vegetarian']],
            ['category' => 'Coffee & Tea', 'name' => 'Latte', 'price' => 380, 'prep_time' => 3, 'ingredients' => ['espresso_beans', 'milk'], 'allergens' => json_encode(['dairy']), 'dietary' => ['vegetarian']],
            ['category' => 'Coffee & Tea', 'name' => 'Ceylon Black Tea', 'price' => 200, 'prep_time' => 4, 'ingredients' => ['black_tea'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],
            ['category' => 'Coffee & Tea', 'name' => 'Green Tea', 'price' => 220, 'prep_time' => 4, 'ingredients' => ['green_tea'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],

            // Juices & Smoothies
            ['category' => 'Fresh Juices & Smoothies', 'name' => 'Fresh Orange Juice', 'price' => 300, 'prep_time' => 2, 'ingredients' => ['oranges'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],
            ['category' => 'Fresh Juices & Smoothies', 'name' => 'Mango Smoothie', 'price' => 450, 'prep_time' => 3, 'ingredients' => ['mango', 'yogurt', 'honey'], 'allergens' => json_encode(['dairy']), 'dietary' => ['vegetarian', 'gluten_free']],
            ['category' => 'Fresh Juices & Smoothies', 'name' => 'Green Smoothie', 'price' => 500, 'prep_time' => 4, 'ingredients' => ['spinach', 'banana', 'apple', 'coconut_milk'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],

            // Breakfast Items
            ['category' => 'Breakfast Items', 'name' => 'English Breakfast', 'price' => 850, 'prep_time' => 12, 'ingredients' => ['eggs', 'bacon', 'sausage', 'baked_beans', 'toast'], 'allergens' => json_encode(['gluten', 'eggs']), 'dietary' => []],
            ['category' => 'Breakfast Items', 'name' => 'Avocado Toast', 'price' => 650, 'prep_time' => 5, 'ingredients' => ['avocado', 'sourdough_bread', 'lime', 'salt'], 'allergens' => json_encode(['gluten']), 'dietary' => ['vegan']],
            ['category' => 'Breakfast Items', 'name' => 'Pancakes', 'price' => 550, 'prep_time' => 8, 'ingredients' => ['flour', 'eggs', 'milk', 'butter'], 'allergens' => json_encode(['gluten', 'dairy', 'eggs']), 'dietary' => ['vegetarian']],

            // Light Meals
            ['category' => 'Light Meals', 'name' => 'Caesar Salad', 'price' => 750, 'prep_time' => 6, 'ingredients' => ['lettuce', 'parmesan', 'croutons', 'caesar_dressing'], 'allergens' => json_encode(['dairy', 'gluten']), 'dietary' => ['vegetarian']],
            ['category' => 'Light Meals', 'name' => 'Grilled Chicken Sandwich', 'price' => 950, 'prep_time' => 10, 'ingredients' => ['chicken_breast', 'bread', 'lettuce', 'tomato'], 'allergens' => json_encode(['gluten']), 'dietary' => []],
            ['category' => 'Light Meals', 'name' => 'Veggie Wrap', 'price' => 650, 'prep_time' => 6, 'ingredients' => ['tortilla', 'hummus', 'vegetables'], 'allergens' => json_encode(['gluten']), 'dietary' => ['vegan']],

            // Pastries & Desserts
            ['category' => 'Pastries & Desserts', 'name' => 'Chocolate Croissant', 'price' => 320, 'prep_time' => 1, 'ingredients' => ['pastry', 'chocolate'], 'allergens' => json_encode(['gluten', 'dairy']), 'dietary' => ['vegetarian']],
            ['category' => 'Pastries & Desserts', 'name' => 'Cheesecake Slice', 'price' => 480, 'prep_time' => 2, 'ingredients' => ['cream_cheese', 'graham_crackers', 'sugar'], 'allergens' => json_encode(['dairy', 'gluten', 'eggs']), 'dietary' => ['vegetarian']],
        ];
    ...
    private function createFullRestaurantMenu(Organization $org): void
    {
        ...
        $menuItems = [
            // Appetizers
            ['category' => 'Appetizers', 'name' => 'Sri Lankan Fish Cutlets', 'price' => 450, 'prep_time' => 8, 'spice_level' => 'mild', 'ingredients' => ['fish', 'potato', 'spices'], 'allergens' => json_encode(['fish', 'gluten']), 'dietary' => []],
            ['category' => 'Appetizers', 'name' => 'Chicken Satay', 'price' => 650, 'prep_time' => 12, 'spice_level' => 'medium', 'ingredients' => ['chicken', 'coconut_milk', 'spices'], 'allergens' => json_encode([]), 'dietary' => ['gluten_free']],
            ['category' => 'Appetizers', 'name' => 'Vegetable Spring Rolls', 'price' => 380, 'prep_time' => 6, 'spice_level' => 'mild', 'ingredients' => ['vegetables', 'spring_roll_wrapper'], 'allergens' => json_encode(['gluten']), 'dietary' => ['vegan']],

            // Soups
            ['category' => 'Soups', 'name' => 'Tom Yum Soup', 'price' => 550, 'prep_time' => 15, 'spice_level' => 'hot', 'ingredients' => ['shrimp', 'lemongrass', 'lime_leaves'], 'allergens' => json_encode(['shellfish']), 'dietary' => ['gluten_free']],
            ['category' => 'Soups', 'name' => 'Coconut Lentil Soup', 'price' => 420, 'prep_time' => 12, 'spice_level' => 'mild', 'ingredients' => ['lentils', 'coconut_milk', 'curry_leaves'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],

            // Salads
            ['category' => 'Salads', 'name' => 'Tropical Fruit Salad', 'price' => 480, 'prep_time' => 5, 'spice_level' => 'none', 'ingredients' => ['mango', 'pineapple', 'papaya'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],
            ['category' => 'Salads', 'name' => 'Grilled Chicken Salad', 'price' => 750, 'prep_time' => 8, 'spice_level' => 'mild', 'ingredients' => ['chicken', 'mixed_greens', 'dressing'], 'allergens' => json_encode([]), 'dietary' => ['gluten_free']],

            // Seafood
            ['category' => 'Seafood', 'name' => 'Grilled Fish with Garlic Butter', 'price' => 1250, 'prep_time' => 18, 'spice_level' => 'mild', 'ingredients' => ['fresh_fish', 'garlic', 'butter'], 'allergens' => json_encode(['fish', 'dairy']), 'dietary' => ['gluten_free']],
            ['category' => 'Seafood', 'name' => 'Prawns Curry', 'price' => 1450, 'prep_time' => 20, 'spice_level' => 'medium', 'ingredients' => ['prawns', 'coconut_milk', 'curry_spices'], 'allergens' => json_encode(['shellfish']), 'dietary' => ['gluten_free']],
            ['category' => 'Seafood', 'name' => 'Crab Curry', 'price' => 1850, 'prep_time' => 25, 'spice_level' => 'hot', 'ingredients' => ['crab', 'coconut_milk', 'curry_spices'], 'allergens' => json_encode(['shellfish']), 'dietary' => ['gluten_free']],

            // Meat & Poultry
            ['category' => 'Meat & Poultry', 'name' => 'Chicken Curry', 'price' => 950, 'prep_time' => 22, 'spice_level' => 'medium', 'ingredients' => ['chicken', 'coconut_milk', 'spices'], 'allergens' => json_encode([]), 'dietary' => ['gluten_free']],
            ['category' => 'Meat & Poultry', 'name' => 'Beef Steak', 'price' => 1650, 'prep_time' => 15, 'spice_level' => 'mild', 'ingredients' => ['beef', 'seasonings'], 'allergens' => json_encode([]), 'dietary' => ['gluten_free']],
            ['category' => 'Meat & Poultry', 'name' => 'Pork Ribs', 'price' => 1350, 'prep_time' => 35, 'spice_level' => 'medium', 'ingredients' => ['pork_ribs', 'bbq_sauce'], 'allergens' => json_encode(['gluten']), 'dietary' => []],

            // Vegetarian
            ['category' => 'Vegetarian', 'name' => 'Dal Curry', 'price' => 450, 'prep_time' => 18, 'spice_level' => 'medium', 'ingredients' => ['lentils', 'coconut_milk', 'spices'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],
            ['category' => 'Vegetarian', 'name' => 'Vegetable Kottu', 'price' => 650, 'prep_time' => 12, 'spice_level' => 'hot', 'ingredients' => ['roti', 'vegetables', 'spices'], 'allergens' => json_encode(['gluten']), 'dietary' => ['vegan']],
            ['category' => 'Vegetarian', 'name' => 'Jackfruit Curry', 'price' => 550, 'prep_time' => 20, 'spice_level' => 'medium', 'ingredients' => ['jackfruit', 'coconut_milk', 'spices'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],

            // Rice & Curry
            ['category' => 'Rice & Curry', 'name' => 'Traditional Rice & Curry', 'price' => 850, 'prep_time' => 25, 'spice_level' => 'medium', 'ingredients' => ['rice', 'curry', 'vegetables'], 'allergens' => json_encode([]), 'dietary' => ['gluten_free']],
            ['category' => 'Rice & Curry', 'name' => 'Biryani', 'price' => 1150, 'prep_time' => 30, 'spice_level' => 'medium', 'ingredients' => ['basmati_rice', 'meat', 'spices'], 'allergens' => json_encode([]), 'dietary' => ['gluten_free']],

            // Desserts
            ['category' => 'Desserts', 'name' => 'Watalappan', 'price' => 350, 'prep_time' => 5, 'spice_level' => 'none', 'ingredients' => ['coconut_milk', 'jaggery', 'eggs'], 'allergens' => json_encode(['eggs']), 'dietary' => ['vegetarian', 'gluten_free']],
            ['category' => 'Desserts', 'name' => 'Chocolate Lava Cake', 'price' => 450, 'prep_time' => 8, 'spice_level' => 'none', 'ingredients' => ['chocolate', 'flour', 'eggs'], 'allergens' => json_encode(['gluten', 'dairy', 'eggs']), 'dietary' => ['vegetarian']],
            ['category' => 'Desserts', 'name' => 'Fresh Fruit Platter', 'price' => 380, 'prep_time' => 3, 'spice_level' => 'none', 'ingredients' => ['seasonal_fruits'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],

            // Beverages
            ['category' => 'Beverages', 'name' => 'Fresh Lime Juice', 'price' => 250, 'prep_time' => 2, 'spice_level' => 'none', 'ingredients' => ['lime', 'water', 'sugar'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],
            ['category' => 'Beverages', 'name' => 'King Coconut', 'price' => 300, 'prep_time' => 1, 'spice_level' => 'none', 'ingredients' => ['king_coconut'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],
            ['category' => 'Beverages', 'name' => 'Ceylon Tea', 'price' => 180, 'prep_time' => 3, 'spice_level' => 'none', 'ingredients' => ['black_tea'], 'allergens' => json_encode([]), 'dietary' => ['vegan', 'gluten_free']],

            // Wine & Spirits
            ['category' => 'Wine & Spirits', 'name' => 'House Red Wine', 'price' => 1200, 'prep_time' => 1, 'spice_level' => 'none', 'ingredients' => ['red_wine'], 'allergens' => json_encode(['sulfites']), 'dietary' => ['vegan'], 'alcohol_content' => '12.5%'],
            ['category' => 'Wine & Spirits', 'name' => 'Local Arrack', 'price' => 400, 'prep_time' => 1, 'spice_level' => 'none', 'ingredients' => ['coconut_arrack'], 'allergens' => json_encode([]), 'dietary' => ['vegan'], 'alcohol_content' => '35%'],
        ];
