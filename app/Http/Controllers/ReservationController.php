...
class ReservationController extends Controller
{
    ...
    /**
     * Create reservation from admin dashboard (AJAX)
     */
    public function createReservationFromAdmin(Request $request)
    {
        $request->validate([
        ...
        try {
            ...
            $branch = $organization->branches()->findOrFail($request->branch_id);
            ...
            $reservation = Reservation::create([
                ...
                'status' => 'confirmed', // Admin-created reservations are auto-confirmed
                'reservation_type' => ReservationType::IN_CALL,
            ...
            Log::info('Reservation created by admin', [
                'reservation_id' => $reservation->id,
                'organization_id' => $organization->id,
                'created_by' => $admin->id
            ]);
            ...
            return response()->json([
                ...
                'reservation' => $reservation->load(['customer', 'branch'])
            ]);
