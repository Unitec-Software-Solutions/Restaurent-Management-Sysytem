...
@section('content')
    <div class="p-4 rounded-lg">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Inventory Stock Management</h2>
                <p class="text-sm text-gray-500">Real-time stock levels across branches</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <x-partials.cards.stats-card title="Total Items" value="{{ $itemsCount ?? 0 }}" 
                trend="Across all branches" icon="fas fa-boxes" color="indigo" />

            <x-partials.cards.stats-card title="In Stock" value="{{ $inStockCount ?? 0 }}" 
                trend="Available items" icon="fas fa-check-circle" color="green" />

            <x-partials.cards.stats-card title="Low Stock" value="{{ $nearReorderCount ?? 0 }}" 
                trend="Needs reordering" icon="fas fa-exclamation-triangle" color="yellow" />

            <x-partials.cards.stats-card title="Out of Stock" value="{{ $outOfStockCount ?? 0 }}" 
                trend="Restock needed" icon="fas fa-times-circle" color="red" />
        </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="font-medium text-gray-900">
                                        ...
                                        <span class="text-xs text-gray-500 ml-1">{{ $stock['item']->unit_of_measurement }}</span>
                                    </div>
