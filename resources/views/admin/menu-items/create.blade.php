    ...
    <div class="p-6">
        ...
        <form method="POST" action="{{ route('admin.menu-items.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                            value="{{ old('name', $itemMaster->name ?? '') }}" required
                    ...
                    <div>
                        ...
                        <select id="type" name="type" required
                            ...
                            @foreach (App\Models\MenuItem::getTypes() as $value => $label)
                                <option value="{{ $value }}"
                                    {{ old('type', $itemMaster ? 1 : 2) == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                @else
                    <input type="hidden" name="item_master_id" value="">
                @endif
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="price" name="price" step="0.01" min="0"
                            value="{{ old('price', $itemMaster->selling_price ?? '') }}" required
                    ...
                    <!-- Cost Price -->
                    <div>
                        <label for="cost_price" class="block text-sm font-medium text-gray-700 mb-1">Cost Price
                            (LKR)</label>
                    ...
                    <!-- Display Order -->
                    <div>
                        <label for="display_order" class="block text-sm font-medium text-gray-700 mb-1">Display
                            Order</label>
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label for="promotion_price" class="block text-sm font-medium text-gray-700 mb-1">Promotion
                                Price (LKR)</label>
                            <input type="number" id="promotion_price" name="promotion_price" step="0.01"
                                min="0" value="{{ old('promotion_price') }}"
                        ...
                        <div>
                            <label for="promotion_start" class="block text-sm font-medium text-gray-700 mb-1">Promotion
                                Start</label>
                        ...
                        <div>
                            <label for="promotion_end" class="block text-sm font-medium text-gray-700 mb-1">Promotion
                                End</label>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="requires_preparation" class="text-sm font-medium text-gray-700">Requires
                            Preparation</label>
                    </div>

                    <!-- Preparation Time -->
                    <div>
                        <label for="preparation_time" class="block text-sm font-medium text-gray-700 mb-1">Preparation
                            Time (minutes)</label>
                    ...
                    <div>
                        ...
                        <input type="text" id="station" name="station" value="{{ old('station') }}"
                ...
                @if ($kitchenStations->count() > 0)
                    <div class="mt-6">
                        <label for="kitchen_station_id" class="block text-sm font-medium text-gray-700 mb-1">Kitchen
                            Station</label>
                        <select id="kitchen_station_id" name="kitchen_station_id"
                            ...
                            @foreach ($kitchenStations as $station)
                                <option value="{{ $station->id }}"
                                    {{ old('kitchen_station_id') == $station->id ? 'selected' : '' }}>
                                    {{ $station->name }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="contains_alcohol" name="contains_alcohol" value="1"
                                ...
                                class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 mr-3">
                            <label for="contains_alcohol" class="text-sm font-medium text-gray-700">Contains
                                Alcohol</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="spice_level" class="block text-sm font-medium text-gray-700 mb-1">Spice
                                Level</label>
                            <select id="spice_level" name="spice_level"
                                ...
                                @foreach (App\Models\MenuItem::getSpiceLevels() as $value => $label)
                                    <option value="{{ $value }}"
                                        {{ old('spice_level', 'mild') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="ingredients" name="ingredients" rows="3" placeholder="List the main ingredients..."
                ...
                <div class="mb-6">
                    <label for="special_instructions" class="block text-sm font-medium text-gray-700 mb-1">Special
                        Instructions</label>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3" placeholder="Internal notes about this menu item..."
