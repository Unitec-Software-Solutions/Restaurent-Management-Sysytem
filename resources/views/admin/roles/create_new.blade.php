            ...
            @php
                $roleTemplates = [
                    'Organization Administrator' => [
                        ...
                        'icon' => 'building',
                        'color' => 'purple',
                        'permissions' => ['organizations.edit', 'branches.manage', 'users.manage', 'roles.manage', 'menus.manage', 'orders.manage', 'inventory.manage', 'suppliers.manage', 'reservations.manage', 'kitchen.manage', 'reports.manage', 'staff.manage', 'subscription.manage', 'settings.edit']
                    ],
