...
<div class="p-6 space-y-10">
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5">
            ...
            <!-- Orders -->
            <x-test-tile label="Orders (Admin)" route="admin.orders.index" />
            <x-test-tile label="Create Takeaway" route="admin.orders.takeaway.create" />
            ...
            <x-test-tile label="Item Categories" route="admin.inventory.categories.index" />
    ...
    {{-- 🧪 ADMIN SAMPLE PAGES --}}
    <div class="space-y-6">
        <h2 class="text-2xl font-semibold text-indigo-700 border-b border-indigo-200 pb-2">🧪 Admin Sample Pages</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5">
