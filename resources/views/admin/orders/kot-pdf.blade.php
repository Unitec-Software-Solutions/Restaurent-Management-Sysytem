...
<head>
    ...
    <title>Admin KOT - Order #{{ $order->order_number }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="kot-container">
        ...
        <div class="kot-header">
            <div class="admin-label">ADMIN GENERATED</div>
        ...
        <div class="order-info">
            ...
            <div class="order-info-row">
                <div class="order-info-left">Total:</div>
                <div class="order-info-right">LKR {{ number_format($order->total, 2) }}</div>
            </div>
        </div>
        ...
        <div class="admin-info">
            <div class="admin-info-title">ADMIN DETAILS:</div>
            <div>Created: {{ $order->created_at->format('d/m/Y H:i:s') }}</div>
            @if($order->steward)
            <div>Steward: {{ $order->steward->first_name }} {{ $order->steward->last_name }}</div>
            @endif
            <div>Status: {{ strtoupper($order->status) }}</div>
            <div>Payment: {{ strtoupper($order->payment_status ?? 'pending') }}</div>
        </div>
        ...
        <div class="kot-footer">
            ...
            <div class="footer-row">Generated by Admin Panel</div>
