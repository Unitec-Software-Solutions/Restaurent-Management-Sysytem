...
<head>
    ...
    <title>RM SYSTEMS - Admin Login</title>
...
<body class="bg-indigo-100 flex items-center justify-center min-h-screen">
    <div class="bg-white rounded-lg p-8 shadow-md w-full max-w-md">
        ...
        <form method="POST" action="{{ route('admin.login') }}">
            ...
            <button type="submit"
                class="w-full bg-indigo-500 text-white py-2 px-4 rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mb-4">
                Login
            </button>
        </form>
    </div>
    ...
    {{-- <footer class="footer-gradient border-t border-[#515DEF]/20">
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="text-center text-gray-700">
                <p>© 2025 RMS Restaurant Management System. All rights reserved.</p>
            </div>
        </div>
    </footer> --}}
