...
<div class="p-4 rounded-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <x-partials.cards.stats-card 
            ...
            value="Rs. {{ number_format($summary['total_payments']) }}" 
            trend="+{{ $summary['increase_percentage'] }}% from last month"
        ...
        <x-partials.cards.stats-card 
            ...
            trend="{{ $summary['pending_count'] }} payments pending"
            icon="fas fa-clock" 
            color="yellow" />
        ...
        <x-partials.cards.stats-card 
            ...
            trend="{{ $summary['overdue_count'] }} overdue payments"
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
        <form method="GET" action="{{ route('admin.payments.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Payment ID, Supplier"
