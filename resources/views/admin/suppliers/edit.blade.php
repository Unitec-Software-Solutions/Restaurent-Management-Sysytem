...
<div class="p-4 rounded-lg">
    <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <form action="{{ isset($supplier) ? route('admin.suppliers.update', $supplier) : route('admin.suppliers.store') }}" 
              method="POST" 
              class="p-6 space-y-6">
            @csrf
            @if(isset($supplier))
            ...
            <div>
                ...
                <div id="vat_number_container" class="mt-3 {{ old('has_vat_registration', $supplier->has_vat_registration ?? false) ? '' : 'hidden' }}">
                    <label for="vat_registration_no" class="block text-sm font-medium text-gray-700">VAT Registration Number</label>
                    <input type="text" 
