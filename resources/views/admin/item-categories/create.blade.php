...
@section('page-header')
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Create Item Category</h1>
            <p class="text-gray-600">Add a new inventory item category</p>
        </div>
        <div>
        ...
        <div class="p-6">
            <form action="{{ route('admin.item-categories.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @error('code')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Maximum 10 characters. Will be used as a unique identifier.
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Active categories can be used when creating inventory items.</p>
                </div>
