...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <form method="GET" class="mb-6 grid grid-cols-1 md:grid-cols-5 gap-4">
            <input type="text" name="phone" value="{{ request('phone') }}" placeholder="Phone" class="form-input rounded border-gray-300" />
            ...
            <input type="date" name="date_from" value="{{ request('date_from') }}" class="form-input rounded border-gray-300" />
            <input type="date" name="date_to" value="{{ request('date_to') }}" class="form-input rounded border-gray-300" />
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 col-span-1 md:col-span-5">Filter</button>
        </form>
